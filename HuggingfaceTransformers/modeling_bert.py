...
class BertSelfAttention(nn.Module):
    # basically what was implemented in MultiHeadAttention.py
    def __init__(self, config):
        super().__init__()
    ...
    def forward(
        ...
        # if attention is being used for encoder-decoder attention, we have hidden states from encoder
        # attention mask needs to deal with padding as well 
...
class BertAttention(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.self = BertSelfAttention(config) # multi-head attention, use config to get structure
